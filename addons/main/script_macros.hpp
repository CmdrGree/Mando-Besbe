...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "mndb_fnc_recompile") then {mndb_recompiles = []; mndb_fnc_recompile = {{call _x} forEach mndb_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; mndb_recompiles pushBack _recomp;
#else
